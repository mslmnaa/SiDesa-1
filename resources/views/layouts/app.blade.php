        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between items-center py-4">
                ...
                <div class="hidden md:flex items-center space-x-6">
                    ...
                    <a href="{{ route('products.index') }}" class="text-secondary-700 hover:text-primary-500 transition-colors">
                        Produk
                    </a>
                </div>
                ...
                <div class="flex items-center space-x-4">
                    @auth
                        <!-- Cart -->
                        <a href="{{ route('cart.index') }}" class="relative text-secondary-700 hover:text-primary-500 transition-colors">
                            ...
                            <span class="absolute -top-2 -right-2 bg-accent-500 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center" id="cart-count">
                        ...
                        <div class="relative" x-data="{ open: false }">
                            ...
                            <div x-show="open" @click.away="open = false" x-transition class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-50">
                                ...
                                <a href="{{ route('orders.index') }}" class="block px-4 py-2 text-sm text-secondary-700 hover:bg-cream">
                                    Riwayat Pesanan
                                </a>
