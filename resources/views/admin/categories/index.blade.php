...
<div class="bg-white rounded-lg shadow p-6 mb-6">
    <form method="GET" action="{{ route('admin.categories.index') }}" class="flex gap-4">
        ...
        <a href="{{ route('admin.categories.index') }}" class="bg-gray-500 text-white px-6 py-2 rounded-md hover:bg-gray-600 transition-colors">
            Reset
        </a>
    </form>
</div>
            ...
            <div class="bg-white rounded-lg shadow overflow-hidden hover:shadow-lg transition-shadow">
                ...
                <div class="p-6">
                    ...
                    <div class="flex space-x-2">
                        ...
                        @else
                            <span class="flex-1 bg-gray-300 text-gray-500 py-2 px-3 rounded text-center text-sm cursor-not-allowed">
                                Hapus
                            </span>
                        @endif
                    </div>
