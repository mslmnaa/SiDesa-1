                ...
                <div class="space-y-4">
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-sm">Setiap donasi diverifikasi dan dicatat dengan transparan</p>
                        </div>
                    </div>
            ...
            <div class="bg-gradient-to-br from-green-100 to-green-200 rounded-2xl p-8">
                ...
                <div class="space-y-4">
                    <div class="flex items-center">
                        <div class="w-8 h-8 bg-green-600 text-white rounded-full flex items-center justify-center font-semibold mr-4">1</div>
                        <p class="text-green-700">Isi form donasi dengan nominal yang diinginkan</p>
                    </div>
                    <div class="flex items-center">
                        <div class="w-8 h-8 bg-green-600 text-white rounded-full flex items-center justify-center font-semibold mr-4">2</div>
                        <p class="text-green-700">Pilih metode pembayaran dan upload bukti</p>
                    </div>
                    <div class="flex items-center">
                        <div class="w-8 h-8 bg-green-600 text-white rounded-full flex items-center justify-center font-semibold mr-4">3</div>
                        <p class="text-green-700">Admin memverifikasi donasi Anda</p>
                    </div>
                    <div class="flex items-center">
                        <div class="w-8 h-8 bg-green-600 text-white rounded-full flex items-center justify-center font-semibold mr-4">4</div>
            ...
            @foreach($recentDonations as $donation)
                <div class="bg-white rounded-lg shadow p-6">
                    <div class="flex items-center mb-4">
                        <div class="w-12 h-12 bg-gradient-to-r from-green-400 to-green-600 rounded-full flex items-center justify-center text-white font-semibold">
...
<section class="py-16 bg-white">
    <div class="max-w-4xl mx-auto px-4 text-center">
        ...
        <p class="text-xl text-gray-600 mb-8">
            Setiap kontribusi Anda, sekecil apapun, akan memberikan dampak besar bagi kehidupan warga desa yang membutuhkan.
        </p>
        <div class="space-x-4">
            <a href="{{ route('infaq.create') }}" 
