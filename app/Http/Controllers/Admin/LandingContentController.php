...
class LandingContentController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.landing-contents.index', compact('contents', 'sections'));
    }
    
    public function create()
    {
        return view('admin.landing-contents.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.landing-contents.index')
                        ->with('success', 'Konten landing page berhasil ditambahkan.');
    }
    
    public function show(LandingContent $landingContent)
    {
        return view('admin.landing-contents.show', compact('landingContent'));
    }
    
    public function edit(LandingContent $landingContent)
    {
        return view('admin.landing-contents.edit', compact('landingContent'));
    }
